...
```{r}
#| code-fold: false
# install.packages(c("readxl", "magrittr", "dplyr", "tidyr", "stringr", "tidyverse", "tidygraph", "igraph", "ggraph", "widyr"))
...
ggsave("figure/sixth_sped_gg.png", width = 6, height = 6)
```

![](figure/sixth_sped_gg.png){width=50% height=50%}
...
ggsave("figure/support_center_gg.png", width = 6, height = 6)
```

![](figure/support_center_gg.png){width=50% height=50%}

**3.7. 학교교육 학교밖 교육연계 단어 네트워크 시각화**
...
ggsave("figure/out_of_school_gg.png", width = 8, height = 6)
```

![](figure/out_of_school_gg.png){width=50% height=50%}
